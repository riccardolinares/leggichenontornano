...
export const metadata = metadatiPagina({
  ...
  descrizione:
    'Segnalate un dato che sembra sbagliato, una pagina che non funziona o una frase che non si capisce. Diventa una segnalazione pubblica, e non serve un account.',
  percorso: '/segnala',
});
  ...
  return (
    <div className="contenitore stretto">
      ...
      <p className="apertura">
        Aiutateci a migliorare il sito. Se un dato vi sembra sbagliato, una pagina non funziona o
        una frase non si capisce, scrivetelo qui: diventa una segnalazione pubblica, e non serve
        avere un account da nessuna parte.
      </p>

      <p className="riga-corpus">
        Vale anche — anzi soprattutto — per le segnalazioni giuridiche. Se una scheda dice che due
        norme non tornano e secondo voi tornano benissimo, quella risposta cambia la precisione
      ...
      <section className="sezione" aria-labelledby="altrimenti">
        <h2 id="altrimenti" className="sezione__titolo">
          Se preferite un altro modo
        </h2>
        <p>
          Una mail a <a href={`mailto:${EMAIL}`}>{EMAIL}</a> arriva nello stesso posto ed è quella
          giusta quando la cosa è delicata e non volete lasciarla pubblica. Se avete un account
          GitHub, <a href={`${REPO_URL}/issues/new`}>aprire una issue direttamente</a> è più rapido
          per tutti.
        </p>
      </section>
    </div>
